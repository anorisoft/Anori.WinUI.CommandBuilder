...
namespace Anori.WinUI.Commands.Builder
{
                                                  ...
                                                  IActivatableSyncCanExecuteBuilder<T>
    {
        ...
        /// <exception cref="SyncCommandBuilder">Sync Command Builder.</exception>
        ...
        private SyncCommandBuilder<T> CanExecute([NotNull] Predicate<T> canExecute)
        {
            if (this.canExecuteFunction != null)
            {
                throw new CanExecuteFunctionAlreadyDefinedException(
                    Resources.ExceptionStrings.CanExecuteFunctionAlreadyDefined);
            }

            if (this.canExecuteSubject != null)
            {
                throw new CanExecuteFunctionAlreadyDefinedException(
                    Resources.ExceptionStrings.CanExecuteExpressionAlreadyDefined);
            }
        ...
        /// </summary>
        /// <returns>Sync Command Builder.</returns>
        /// <exception cref="CommandBuilderException">Command Builder Exception.Command Builder Exception.</exception>
        [NotNull]
